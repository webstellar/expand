...
const Services: React.FC<pageProps> = ({ data }) => {
  return (
    <div className="bg-transparent flex flex-wrap md:flex-nowrap mx-auto flex-row max-w-7xl items-center justify-start p-6 lg:px-6 gap-x-5 gap-y-10 md:gap-y-0 mb-10 md:mb-20">
